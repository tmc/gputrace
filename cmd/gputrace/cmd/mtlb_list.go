...
type mtlbListOptions struct{}

var mtlbListCmd = newMTLBListCommand(new(mtlbListOptions))

func newMTLBListCommand(opts *mtlbListOptions) *cobra.Command {
	return &cobra.Command{
		Use:   "list <trace>",
		Short: "List all Metal Library files in a trace",
		Args:  cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			return runMTLBList(cmd, args, opts)
		},
	}
}

func runMTLBList(cmd *cobra.Command, args []string, _ *mtlbListOptions) error {
	tracePath := args[0]
