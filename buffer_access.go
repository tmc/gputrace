...
func (t *Trace) AnalyzeBufferAccess() (*BufferAccessAnalysis, error) {
...
func (t *Trace) parseAllBufferBindings() ([]BufferAccessBinding, error) {
...
func (t *Trace) buildBufferAddressMapping() (map[uint64][]string, error) {
...
func (t *Trace) FormatBufferAccessReport(analysis *BufferAccessAnalysis) string {
