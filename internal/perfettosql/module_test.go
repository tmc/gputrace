...
func TestModuleProjectsRecordedDispatchesAndCompilerFacts(t *testing.T) {
	for _, want := range []string{
		...
		"presentation_pipeline_tracks",
		"presentation_pipeline_events",
		"presentation_encoder_tracks",
		"presentation_encoder_events",
		"presentation_uncertain_tracks",
		"presentation_uncertain_events",
		"a.display_value",
